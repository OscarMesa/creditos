...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'solicitud-prestamo-form',
        'action' => Yii::app()->createAbsoluteUrl('solicitudPrestamo/create'),
...
<div class="form-group sl2">
            <?php
                    ...
                    echo $form->hiddenField($model, 'cliente', array('class' => 'form-control','id' => 'SolicitudPrestamo_cliente_1'));

                    $this->widget('ext.select2.ESelect2', array(
                        'selector' => '#SolicitudPrestamo_cliente_1',
                        'model' => $model,
                        'attribute' => 'cliente',
                        'data' => array(),
                        'options' => array(
...
<div class="form-group">
    ...
    <div class="form-group sl2">   
            <?php
                    ...
                    echo $form->hiddenField($model, 'estado_solicitud', array('class' => 'form-control','id' => 'SolicitudPrestamo_estado_solicitud_1'));

                    $this->widget('ext.select2.ESelect2', array(
                        'selector' => '#SolicitudPrestamo_estado_solicitud_1',
                        'model' => $model,
