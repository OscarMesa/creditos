...
class UiController extends Controller {
    ...
    public function actionUserManagementAdmin() {
        ...
        $this->titlePage = ucwords(CrugeTranslator::t('admin', 'Manage Users'));
    ...
    public function actionFieldsAdminList() {
        $this->layout = '//layouts/column2';
        $this->titlePage = ucwords(CrugeTranslator::t("campos personalizados"));
    ...
    private function _fieldAdminForm($model) {
        $this->layout = '//layouts/column2';
        $this->titlePage = ucwords(CrugeTranslator::t(
