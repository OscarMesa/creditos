...
<div class='box box-primary crugepanel user-assignments-role-list'>
    <section class="box-header"><h3><?php echo ucfirst(CrugeTranslator::t("Roles Disponibles")); ?></h3></section>
    <div class="box-body" >	
...
<div class='box box-primary user-assignments-detail'>
    <div class="box-body" >	
        <div class="col-md-3"><div class="callout callout-warning"><p id='mostrarSeleccion' class=""></p></div></div>
        <div id='lista1' class='lista'>
            <div id='revocarSeleccion' class='btn bg-olive btn-flat margin'>
        ...
        <div id='lista2' class='lista'>
            <div id='asignarSeleccion' class='btn bg-olive btn-flat margin'>
