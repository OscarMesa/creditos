...
class CrugeUi extends CComponent
{
    ...
    public function getFieldAdminCreateLink($label = null, $htmlOptions = array())
    {
        if ($label === null) {
            $label = 'Create Field';
        }
        return CHtml::link(CrugeTranslator::t('admin', $label), self::getFieldsAdminCreateUrl(),$htmlOptions);
    }
    ...
    */
    ...
    public function tbutton($texto,$htmlOptions = array())
    {
        $this->_button($texto,null,$htmlOptions);
    }

    private function _button($label, $name = null,$htmlOptions = array())
    {
        $ar = array();
        ...
        $ar = array_merge(array('name' => $name),$htmlOptions);
